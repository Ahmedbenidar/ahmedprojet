<?php
 ...
 if(isset($_POST['submitB'])){
    ...
    $clients=Client::selectClientsByCity('clients',$connection->conn,$_POST['filiere']);
...
<div class="container my-5">
  ...
  <div class="row mb-3">
           ...
           ?>
            ...
            <label class="col-form-label col-sm-1" for="filiere">filiere:</label>
            <div class="col-sm-6">
           ...
           <?php
                ...
                include("filiere.php");
                $filiere = filiere::selectAllCities('filiere',$connection->conn);
...
foreach($clients as $row){
    ...
    $filiere = filiere::selectCityById('filiere',$connection->conn,$row['idfiliere']);
